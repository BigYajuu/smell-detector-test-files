...
class TestYoutubeSubtitles(BaseTestSubtitles):
    ...
    def test_youtube_allsubtitles(self):    # Anony
    ...
    def _test_subtitles_format(self, fmt, md5_hash, lang='en'): # Anony
        ...
        subtitles = self.getSubtitles()
        self.assertEqual(md5(subtitles[lang]), md5_hash)    # not ARV

    def test_youtube_subtitles_ttml_format(self):   # Anony
        self._test_subtitles_format('ttml', 'c97ddf1217390906fa9fbd34901f3da2') # not ARV

    def test_youtube_subtitles_vtt_format(self):    # Anony
        self._test_subtitles_format('vtt', 'ae1bd34126571a77aabd4d276b28044d')  # not ARV

    def test_youtube_subtitles_json3_format(self):  # Anony
        self._test_subtitles_format('json3', '688dd1ce0981683867e7fe6fde2a224b')    # not ARV

    def _test_automatic_captions(self, url, lang):  # Anony
        self.url = url
        self.DL.params['writeautomaticsub'] = True
        self.DL.params['subtitleslangs'] = [lang]
        subtitles = self.getSubtitles()
        self.assertTrue(subtitles[lang] is not None)    # not ARV

    def test_youtube_automatic_captions(self):  # Anony
    ...
    def test_youtube_nosubtitles(self): # Anony
        ...
        self.DL.params['allsubtitles'] = True
        subtitles = self.getSubtitles()
        self.assertFalse(subtitles) # not ARV
...
class TestRaiPlaySubtitles(BaseTestSubtitles):
    ...
    def test_subtitles_key(self):   # Anony
    ...
    def test_subtitles_array_key(self): # Anony
...
class TestDemocracynowSubtitles(BaseTestSubtitles):
    ...
    def test_subtitles_in_page(self):   # Anony
